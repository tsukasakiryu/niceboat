...
(lib.bg = function() {
	this.initialize(img._432_3_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1232,1356);


(lib.bg_blur = function() {
	this.initialize(img._432_3_bg_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1232,1356);


(lib.ch_base = function() {
	this.initialize(img._432_3_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1232,1356);


(lib.ch_face2 = function() {
	this.initialize(img._432_3_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.ch_face3 = function() {
	this.initialize(img._432_3_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.ch_face4 = function() {
	this.initialize(img._432_3_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.ch_face6 = function() {
	this.initialize(img._432_3_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.ch_face7 = function() {
	this.initialize(img._432_3_ch_face7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.ch_face8 = function() {
	this.initialize(img._432_3_ch_face8);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.ch_face9 = function() {
	this.initialize(img._432_3_ch_face9);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.ef_breath = function() {
	this.initialize(img._432_3_ef_breath);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,210,199);


(lib.ef_yuge = function() {
	this.initialize(img._432_3_ef_yuge);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,300,238);


(lib.finish = function() {
	this.initialize(img._432_3_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._432_3_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.sun_light = function() {
	this.initialize(img._432_3_sun_light);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,48,284);


(lib.tie_fp = function() {
	this.initialize(img._432_3_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._432_3_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
(lib.maeker = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(102,102,102,0.498)").s().p("AhYBbIAAi1ICxAAIAAC1g");
	this.shape.setTransform(8.85,9.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.maeker, new cjs.Rectangle(0,0,17.7,18.2), null);
...
(lib.ef_yuge_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー_1
	this.instance = new lib.ef_yuge();
	this.instance.parent = this;
	this.instance.setTransform(-75,-59.5,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.ef_yuge_1, new cjs.Rectangle(-75,-59.5,150,119), null);


(lib.ef_breath_core = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー_1
	this.instance = new lib.ef_breath();
	this.instance.parent = this;
	this.instance.setTransform(0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.ef_breath_core, new cjs.Rectangle(0,0,105,99.5), null);
...
}).prototype = getMCSymbolPrototype(lib.character1_base, new cjs.Rectangle(-120,-396,616,678), null);
...
(lib.bg_core = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.bg_core, new cjs.Rectangle(0,0,616,678), null);


(lib.bg_blur_core = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.bg_blur_core, new cjs.Rectangle(0,0,616,678), null);
...
(lib.tie = function(mode,startPosition,loop) {
	...
	// txt
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("AgsBLIAAhCIgKAJIgNAJIgIgPQAPgIAKgIQALgIAFgGIAJgLIADgFIgsAAIAAgPIAWAAIAAgZIAQAAIAAAZIAWAAIAAAPIgBAEIgGAJIgKANQADAEAGAEIANAIIgKANIgJgJIgIgJIAABIgAgKBDIAAgOIAkAAIAAg9IgcAAIAAgQIAcAAIAAgyIAQAAIAAAyIAfAAIAAAQIgfAAIAAA9IAiAAIAAAOg");
	this.shape.setTransform(31.975,0.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("");
	this.shape_1.setTransform(15.85,0.4);
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("AhIA8QAOgIAJgKQAIgJAEgLQAEgLABgNIABgeIgoAAIAAgPIBBAAIAAgaIAQAAIAAAaIA/AAIAAAPIhYAAIAAANIgBAMIBKAAIgBAkQAAAPgDAJQgCAIgFAFQgFAEgJABQgIABgMAAIgHgRIAHABIAFAAIAMgBQAFgCACgFQADgEAAgKIABgbIg6AAQgCAOgEAMQgFALgIAKQgJALgPAJg");
	this.shape_3.setTransform(-16.075,0.525);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("");
	this.shape_4.setTransform(-32,0.1875);
...
(lib.ef_yuge_anim = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// yuge
	this.m = new lib.maeker();
	this.m.name = "m";
	this.m.parent = this;
	this.m.setTransform(-69.25,1.25,1,1,0,0,0,8.8,9.1);

	this.timeline.addTween(cjs.Tween.get(this.m).to({_off:true},1).wait(83));

	// yuge
	this.instance = new lib.ef_yuge_1();
	this.instance.parent = this;
	this.instance.setTransform(-74.55,-27,0.3696,0.3696,0,0,180,0.1,0);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(42).to({_off:false},0).to({regY:-0.1,y:-36.25,alpha:0.7813},11).to({y:-69.3,alpha:0},30).wait(1));

	// yuge
	this.instance_1 = new lib.ef_yuge_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-69.6,-25.65,0.4173,0.4173,0,0,0,-0.1,-0.1);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(19).to({_off:false},0).to({y:-36.1,alpha:0.7813},11).to({y:-73.35,alpha:0},34).to({_off:true},1).wait(19));

	// yuge
	this.instance_2 = new lib.ef_yuge_1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-71.4,-23.55,0.4793,0.4793,0,0,180,-0.1,-0.2);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(4).to({_off:false},0).to({regY:-0.3,y:-35.6,alpha:0.7813},11).to({regX:-0.2,regY:-0.1,x:-72.4,y:-58.85,alpha:0},34).to({_off:true},1).wait(34));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-108.4,-98.1,72.9,108.5);


(lib.ef_yuge_amnim2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// yuge
	this.instance = new lib.ef_breath_core();
	this.instance.parent = this;
	this.instance.setTransform(52.5,59.4,1,1,0,0,0,52.5,49.8);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(13).to({_off:false},0).to({y:40.25,alpha:1},22).to({y:24.65,alpha:0},18).to({_off:true},1).wait(14).to({_off:false,y:59.4},0).to({y:40.25,alpha:1},22).to({y:24.65,alpha:0},18).to({_off:true},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-25.1,105,134.2);
...
(lib.character1_face = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},1).wait(8));

	// body
	this.b = new lib.character1_base();
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-96,250);
...
p.nominalBounds = new cjs.Rectangle(1,1,160,160);
...
(lib.window = function(mode,startPosition,loop) {
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("");
	this.shape_2.setTransform(24.325,11.975);
...
(lib.glitters = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(15.1,214.35,0.1958,0.1958);
	this.instance_1._off = true;
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(220.4,191.55,0.1412,0.1412);
	this.instance_2._off = true;
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(228.75,133.9,0.159,0.159,0,0,0,-1.3,2.9);
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(226.8,75.6,0.0849,0.0849);
	...
	this.instance_6.parent = this;
	this.instance_6.setTransform(206,22.65,0.1362,0.1362);
	...
	this.instance_7.parent = this;
	this.instance_7.setTransform(12.6,157.6,0.1106,0.1106);
	...
	this.instance_9.parent = this;
	this.instance_9.setTransform(113.5,11.15,0.2555,0.2555);
	...
	this.instance_10.parent = this;
	this.instance_10.setTransform(176.3,244.45,0.1176,0.1176);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.face_blink_ary = [1, 1, 1, 0, 1, 0, 0, 1, 0, 0, 1, 0, 1, 1, 1]; 
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("ApnDpQgdgDgmgXQgngYgbggQhEhTBFg3QBvhfA/guQBxhSBSgDQBegDBaAPQBTAOBGAcQA2AWAdgJQAZgHB5gnQCIgjBhgFQBugFBdAfQBaAeAqBKQAlA/gOA8QgEAUACAcQACAegCAIQgGAhhOADQhNADhwgPQh2gSgwgFQg0gGhXgcQhTgbgSgBQgYgBgaAHQgRAFABgDQgJAMggASQhDAkh5AfQjYA2glAIQheAVgzAAIgUgBg");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:79.976,y:60.1891}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.f2).wait(5).to({alpha:0.1992},0).wait(1).to({regX:81,regY:81,x:81,y:81,alpha:0.6441},0).wait(1).to({alpha:0.911},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:1},0).wait(19));
	...
	this.timeline.addTween(cjs.Tween.get(this.f1_alpha).wait(5).to({alpha:0.8008},0).wait(1).to({regX:81,regY:81,x:81,y:81,alpha:0.7118},0).wait(1).to({alpha:0.4449},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(19));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-216,-146,616,678);
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	// yuge
	this.instance = new lib.ef_yuge_anim();
	this.instance.parent = this;
	this.instance.setTransform(115.65,-169.05);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(2));

	// yuge2
	this.instance_1 = new lib.ef_yuge_amnim2();
	this.instance_1.parent = this;
	this.instance_1.setTransform(52.5,-198.1,1,1,0,0,0,52.5,49.8);
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-177,-192);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-297,-588,616,719.7);


(lib.bg_zoom_half = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{"def":0,n_to_b:1,blur:22});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(18).call(this.frame_18).wait(4).call(this.frame_22).wait(1));

	// sun_effect
	this.instance = new lib.hikari2();
	this.instance.parent = this;
	this.instance.setTransform(726.45,-128.9,1.1946,1.3897,83.0001,0,0,-42.5,-92.7);
	...
	// yuge2
	this.instance_1 = new lib.ef_yuge_anim();
	this.instance_1.parent = this;
	this.instance_1.setTransform(527.1,280.6,0.4,0.4,0,0,0,0,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:true},1).wait(22));

	// yuge
	this.instance_2 = new lib.ef_yuge_anim();
	this.instance_2.parent = this;
	this.instance_2.setTransform(497.45,280.6,0.4,0.4,0,0,0,0,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({_off:true},1).wait(22));

	// bg_image
	this.instance_3 = new lib.bg_blur_core();
	this.instance_3.parent = this;
	this.instance_3.setTransform(308,339,1,1,0,0,0,308,339);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({_off:false},0).wait(1).to({alpha:0.0037},0).wait(1).to({alpha:0.0158},0).wait(1).to({alpha:0.0377},0).wait(1).to({alpha:0.0714},0).wait(1).to({alpha:0.1196},0).wait(1).to({alpha:0.185},0).wait(1).to({alpha:0.2708},0).wait(1).to({alpha:0.3785},0).wait(1).to({alpha:0.5049},0).wait(1).to({alpha:0.638},0).wait(1).to({alpha:0.7596},0).wait(1).to({alpha:0.8566},0).wait(1).to({alpha:0.9256},0).wait(1).to({alpha:0.9696},0).wait(1).to({alpha:0.993},0).wait(1).to({alpha:1},0).wait(6));

	// bg_image
	this.instance_4 = new lib.bg_core();
	this.instance_4.parent = this;
	this.instance_4.setTransform(308,339,1,1,0,0,0,308,339);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({_off:true},17).wait(6));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-120.4,793.1,798.4);
...
(lib.character1_container = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{standby:0,jump:8,jump2:16,jump_double:25,jump_flower:37,jump_flower2:47,nod:57,nod2:66,nod_double:81,swing:92,swing_on:112,swing_off:121,notice:132,notice_jump:146,laugh:160,chord:181,question:201,question_on:229,question_off:241,exclamation:252,down:268,down2:295,shy:313,shy_down:325,shock:343,sigh:350,happy:369,anger:384,anger2:404,damage:416,concent:433,nod_chord:442});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(7).call(this.frame_7).wait(1).call(this.frame_8).wait(7).call(this.frame_15).wait(1).call(this.frame_16).wait(8).call(this.frame_24).wait(1).call(this.frame_25).wait(11).call(this.frame_36).wait(1).call(this.frame_37).wait(9).call(this.frame_46).wait(1).call(this.frame_47).wait(9).call(this.frame_56).wait(1).call(this.frame_57).wait(8).call(this.frame_65).wait(1).call(this.frame_66).wait(14).call(this.frame_80).wait(1).call(this.frame_81).wait(10).call(this.frame_91).wait(1).call(this.frame_92).wait(19).call(this.frame_111).wait(1).call(this.frame_112).wait(8).call(this.frame_120).wait(1).call(this.frame_121).wait(10).call(this.frame_131).wait(1).call(this.frame_132).wait(13).call(this.frame_145).wait(1).call(this.frame_146).wait(13).call(this.frame_159).wait(1).call(this.frame_160).wait(20).call(this.frame_180).wait(1).call(this.frame_181).wait(19).call(this.frame_200).wait(1).call(this.frame_201).wait(27).call(this.frame_228).wait(1).call(this.frame_229).wait(11).call(this.frame_240).wait(1).call(this.frame_241).wait(10).call(this.frame_251).wait(1).call(this.frame_252).wait(15).call(this.frame_267).wait(1).call(this.frame_268).wait(26).call(this.frame_294).wait(1).call(this.frame_295).wait(17).call(this.frame_312).wait(1).call(this.frame_313).wait(11).call(this.frame_324).wait(1).call(this.frame_325).wait(17).call(this.frame_342).wait(1).call(this.frame_343).wait(6).call(this.frame_349).wait(1).call(this.frame_350).wait(18).call(this.frame_368).wait(1).call(this.frame_369).wait(14).call(this.frame_383).wait(1).call(this.frame_384).wait(19).call(this.frame_403).wait(1).call(this.frame_404).wait(11).call(this.frame_415).wait(1).call(this.frame_416).wait(16).call(this.frame_432).wait(1).call(this.frame_433).wait(8).call(this.frame_441).wait(1).call(this.frame_442).wait(22).call(this.frame_464).wait(1));

	// effect_look_to_right2
	this.instance = new lib.drop1_v2("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(59.1,-450.45,1.1645,1.1645,0,0,180);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(313).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:84.7,y:-459.45,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:96.35,y:-463.75,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,skewX:0,skewY:180,x:59.1,y:-450.45,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:84.7,y:-459.45,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:96.35,y:-463.75,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,skewX:0,skewY:180,x:59.1,y:-450.45,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:84.7,y:-459.45,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:96.35,y:-463.75,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,skewX:0,skewY:180,x:59.1,y:-450.45,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:84.7,y:-459.45,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:96.35,y:-463.75,alpha:0.2188},0).to({_off:true},1).wait(133));

	// effect_look_to_right
	this.instance_1 = new lib.spread_flower_pink("synched",0,false);
	this.instance_1.parent = this;
	this.instance_1.setTransform(0.95,-357.7,1.4807,1.4807,0,0,180);

	this.instance_2 = new lib.good_effect("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(1,-357.75,1.481,1.481);

	this.instance_3 = new lib.notice();
	this.instance_3.parent = this;
	this.instance_3.setTransform(74.65,-446,1.1857,1.1857,169.9438,0,0,-29.1,20.5);
	this.instance_3._off = true;

	this.instance_4 = new lib.laugh("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(90.65,-442.45,1.4181,1.4181,0,-35.8376,144.173,-30.2,20.5);
	this.instance_4._off = true;

	this.instance_5 = new lib.chord("synched",0,false);
	this.instance_5.parent = this;
	this.instance_5.setTransform(67.55,-360.05,1.0026,1.0026,-6.2632,0,0,-23.4,76.9);

	this.instance_6 = new lib.question();
	this.instance_6.parent = this;
	this.instance_6.setTransform(62.85,-442.95,1.053,1.053,29.448);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.instance_7 = new lib.mc_exclamation("synched",0,false);
	this.instance_7.parent = this;
	this.instance_7.setTransform(66.6,-458.35,1.0929,1.0929,0,30,-150.0007,-0.1,0.1);

	this.instance_8 = new lib.drop1a("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(62.3,-440.85,1,1,0,0,0,-0.5,0.2);
	this.instance_8._off = true;

	this.instance_9 = new lib.drop2_v2("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(60.9,-440.7,0.9876,0.9876,0,-14.9998,165.0002);
	this.instance_9._off = true;

	this.instance_10 = new lib.shock("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(67.35,-443.7,1.3878,1.3878,0,121.2396,-58.7604);

	this.instance_11 = new lib.sigh("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(40.9,-290.4,1,1,0,0,180);
	this.instance_11.alpha = 0.6016;
	this.instance_11._off = true;

	this.instance_12 = new lib.heart("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(67.55,-399.85,0.4532,0.4532,0,0,180);
	this.instance_12._off = true;

	this.instance_13 = new lib.angry("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(74.1,-421.1,0.5276,0.5276);
	this.instance_13._off = true;

	this.instance_14 = new lib.mc_punpun();
	this.instance_14.parent = this;
	this.instance_14.setTransform(-56.95,-470.25,1.1377,1.1377);

	this.instance_15 = new lib.concent_wrapper("synched",0,false);
	this.instance_15.parent = this;
	this.instance_15.setTransform(0.75,-358.3,1,1,0,0,0,-0.5,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1}]},37).to({state:[{t:this.instance_2}]},10).to({state:[]},10).to({state:[{t:this.instance_3}]},76).to({state:[]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[]},1).to({state:[{t:this.instance_3}]},2).to({state:[]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},15).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},20).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},7).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_6}]},6).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_7}]},5).to({state:[{t:this.instance_8}]},16).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},9).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},24).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},11).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},3).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_12}]},11).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},2).to({state:[{t:this.instance_12}]},3).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[]},1).to({state:[{t:this.instance_13}]},6).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},5).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[]},1).to({state:[{t:this.instance_14}]},2).to({state:[]},12).to({state:[{t:this.instance_15}]},17).to({state:[{t:this.instance_5}]},9).to({state:[]},20).wait(3));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false,scaleX:1.1864,scaleY:1.1864,rotation:169.9437,y:-446.05},0).wait(3).to({regX:-28.8,x:74.25,y:-445.9,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,x:74.65,y:-446.05,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,scaleX:1.1857,scaleY:1.1857,rotation:169.9438,y:-446,alpha:1},0).to({_off:true},2).wait(1).to({_off:false,scaleX:1.1864,scaleY:1.1864,rotation:169.9437,y:-446.05},0).wait(3).to({regX:-28.8,x:74.25,y:-445.9,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,x:74.65,y:-446.05,alpha:0},0).to({_off:true},1).wait(306));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(160).to({_off:false},0).wait(15).to({regX:-30.3,regY:20.4,skewX:-35.827,skewY:144.1725,x:90.7,y:-442.6},0).wait(1).to({regX:-31.4,regY:22.1,x:93.35,y:-441.55,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.4,x:90.7,y:-442.6,alpha:0,startPosition:19},0).to({_off:true},1).wait(285));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:70.5,y:-455.9,alpha:0.5556},0).wait(1).to({x:75.3,y:-463.75,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:77.25,y:-466.55,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:76.6,y:-465.8},0).wait(1).to({x:75.55,y:-463.95},0).wait(1).to({x:73.8,y:-460.85},0).wait(1).to({regX:0,regY:0,x:71.65,y:-456.65},0).to({x:72.4,y:-458},2).wait(8).to({regX:-0.2,regY:0.2,x:71.75,y:-457.3,alpha:0.9298},0).wait(1).to({x:70.65,y:-455.35,alpha:0.692},0).wait(1).to({x:69.05,y:-452.5,alpha:0.339},0).wait(1).to({x:67.85,y:-450.4,alpha:0.0788},0).wait(1).to({regX:0,regY:0,y:-449.85,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:62.85,y:-442.95},0).wait(1).to({regX:-0.2,regY:0.2,x:70.5,y:-455.9,alpha:0.5556},0).wait(1).to({x:75.3,y:-463.75,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:77.25,y:-466.55,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:76.6,y:-465.8},0).wait(1).to({x:75.55,y:-463.95},0).wait(1).to({x:73.8,y:-460.85},0).wait(1).to({regX:0,regY:0,x:71.65,y:-456.65},0).to({x:72.4,y:-458},2).wait(3).to({regX:-0.2,regY:0.2,x:71.75,y:-457.3,alpha:0.9298},0).wait(1).to({x:70.65,y:-455.35,alpha:0.692},0).wait(1).to({x:69.05,y:-452.5,alpha:0.339},0).wait(1).to({x:67.85,y:-450.4,alpha:0.0788},0).wait(1).to({regX:0,regY:0,y:-449.85,alpha:0},0).to({_off:true},1).wait(218));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:63.3,y:-437.15},0).wait(1).to({y:-433.3},0).wait(1).to({y:-430.05},0).wait(1).to({y:-427.4},0).wait(1).to({y:-425.3},0).wait(1).to({y:-423.8},0).wait(1).to({y:-422.9},0).wait(1).to({regX:-0.5,regY:0.2,x:62.3,y:-421.85},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:63.3,y:-422.65,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:62.3,y:-421.85,alpha:0},0).to({_off:true},1).wait(176));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(313).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:92.325,y:-436.0875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:102.8,y:-434.55,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:60.9,y:-440.7,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:92.325,y:-440.475,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:102.8,y:-440.4,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:60.9,y:-440.7,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:92.325,y:-436.0875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:102.8,y:-434.55,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:60.9,y:-440.7,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:92.325,y:-440.475,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:102.8,y:-440.4,alpha:0.2188},0).to({_off:true},1).wait(133));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(351).to({_off:false},0).wait(1).to({x:41.9,y:-289.4,alpha:1},0).wait(1).to({regX:0.9,x:42,y:-288.45,alpha:0.8965},0).wait(1).to({x:43.35,y:-287.25,alpha:0.7636},0).wait(1).to({x:44.95,y:-285.8,alpha:0.6048},0).wait(1).to({x:46.75,y:-284.2,alpha:0.4229},0).wait(1).to({x:48.75,y:-282.35,alpha:0.2205},0).wait(1).to({regX:0,x:51.9,y:-280.4,alpha:0},0).to({_off:true},1).wait(106));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:69.3,y:-414},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:72.55,y:-419.85},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:70,y:-417.7},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:69.45,y:-414.45},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:70.55,y:-409.85},0).to({scaleX:1,scaleY:1,x:71.55,y:-413.85},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:68.95,y:-412.85,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:70.55,y:-413.6,alpha:0.1016},0).to({_off:true},1).wait(82));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(389).to({_off:false},0).wait(1).to({scaleX:1.0714,scaleY:1.0714,y:-424.85},0).wait(1).to({scaleX:1.2527,scaleY:1.2527,y:-426.1},0).wait(1).to({scaleX:0.9864,scaleY:0.9864},0).wait(1).to({scaleX:0.8976,scaleY:0.8976},0).wait(5).to({startPosition:0},0).wait(1).to({alpha:0.5009},0).wait(1).to({alpha:0.2014},0).wait(1).to({alpha:0.1016},0).to({_off:true},1).wait(63));
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:11,regY:-249,x:11,y:-257.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:11,regY:-249,x:11,y:-258.2},0).wait(1).to({y:-255.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:11,regY:-249,x:11,y:-254.5},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:11,regY:-249,x:11,y:-254.75},0).wait(1).to({y:-247.8},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:11,regY:-249,x:11,y:-245.75},0).wait(1).to({y:-248.15},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:11,regY:-249,x:11,y:-253.95},0).wait(1).to({y:-248.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:11,regY:-249,x:11,y:-253.95},0).wait(1).to({y:-248.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:11,regY:-249,x:11,y:-248.1},0).wait(1).to({y:-248.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:11,regY:-249,x:11,y:-258},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:11,regY:-249,x:11,y:-261.95},0).wait(1).to({y:-258.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:11,regY:-249,x:11,y:-247},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:11,regY:-249,x:11,y:-249.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:11,regY:-249,x:11,y:-258},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:11,regY:-249,x:11,y:-261.95},0).wait(1).to({y:-258.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:11,regY:-249,x:11,y:-247},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:11,regY:-249,x:11,y:-249.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:11,regY:-249,x:11,y:-248.4},0).wait(1).to({y:-246},0).wait(1).to({y:-243.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:11,regY:-249,x:11,y:-243.65},0).wait(1).to({y:-246},0).wait(1).to({y:-248.4},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:11,regY:-249,x:11,y:-248.85},0).wait(1).to({y:-248.3},0).wait(1).to({y:-247.2},0).wait(1).to({y:-245.85},0).wait(1).to({y:-244.75},0).wait(1).to({y:-244.2},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:11,regY:-249,x:11,y:-244.2},0).wait(1).to({y:-244.75},0).wait(1).to({y:-245.85},0).wait(1).to({y:-247.2},0).wait(1).to({y:-248.3},0).wait(1).to({y:-248.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:11,regY:-249,x:11,y:-244.25},0).wait(1).to({y:-247.8},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:11,regY:-249,x:11,y:-246.8},0).wait(1).to({y:-248.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:11,regY:-249,rotation:0.0163,x:11.05,y:-249},0).wait(1).to({rotation:0.0729,x:11.4,y:-248.85},0).wait(1).to({rotation:0.1837,x:12.15,y:-248.55},0).wait(1).to({rotation:0.3594,x:13.25,y:-248.15},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.5799,x:14.65,y:-247.55},0).wait(1).to({rotation:0.7798,x:15.95,y:-247.05},0).wait(1).to({rotation:0.9131,x:16.75,y:-246.7},0).wait(1).to({rotation:0.9816,x:17.2,y:-246.5},0).wait(1).to({regX:0.1,regY:0.1,rotation:1.0012,x:2,y:2.3},0).wait(1).to({regX:11,regY:-249,rotation:0.9878,x:17.15,y:-246.6},0).wait(1).to({rotation:0.9422,x:16.85,y:-246.7},0).wait(1).to({rotation:0.854,x:16.3,y:-246.95},0).wait(1).to({rotation:0.7134,x:15.4,y:-247.25},0).wait(1).to({rotation:0.5231,x:14.2,y:-247.75},0).wait(1).to({rotation:0.3199,x:12.95,y:-248.3},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.1551,x:11.85,y:-248.7},0).wait(1).to({rotation:0.0485,x:11.2,y:-248.95},0).wait(1).to({rotation:-0.0067,x:10.9,y:-249.05},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:11,regY:-249,rotation:0.0244,x:11.1,y:-248.95},0).wait(1).to({rotation:0.1092,x:11.55,y:-248.65},0).wait(1).to({rotation:0.275,x:12.55,y:-248.05},0).wait(1).to({rotation:0.538,x:14.05,y:-247.15},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:15.9,y:-245.95},0).wait(1).to({rotation:1.1673,x:17.6,y:-244.85},0).wait(1).to({rotation:1.367,x:18.75,y:-244.1},0).wait(1).to({rotation:1.4695,x:19.35,y:-243.7},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:11,regY:-249,rotation:1.4793,x:19.3,y:-243.75},0).wait(1).to({rotation:1.4124,x:18.95,y:-244},0).wait(1).to({rotation:1.2834,x:18.2,y:-244.45},0).wait(1).to({rotation:1.0775,x:17.05,y:-245.25},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.7991,x:15.45,y:-246.2},0).wait(1).to({rotation:0.5016,x:13.8,y:-247.3},0).wait(1).to({rotation:0.2603,x:12.4,y:-248.15},0).wait(1).to({rotation:0.1043,x:11.5,y:-248.75},0).wait(1).to({rotation:0.0235,x:11.1,y:-249},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:11,regY:-249,x:11,y:-254.55},0).wait(1).to({y:-256.45},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:11,regY:-249,x:11,y:-256.35},0).wait(1).to({y:-254.25},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:11,regY:-249,x:11,y:-257.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:11,regY:-249,x:11,y:-258.2},0).wait(1).to({y:-255.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15).to({regX:11,regY:-249,rotation:-0.0253,x:10.9,y:-248.9},0).wait(1).to({rotation:-0.1129,x:10.6,y:-248.35},0).wait(1).to({rotation:-0.2845,x:10.1,y:-247.4},0).wait(1).to({rotation:-0.5565,x:9.3,y:-245.9},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:8.25,y:-243.9},0).wait(1).to({rotation:-1.2075,x:7.3,y:-242.15},0).wait(1).to({rotation:-1.4141,x:6.65,y:-240.95},0).wait(1).to({rotation:-1.5201,x:6.35,y:-240.4},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:9},0).wait(1).to({regX:11,regY:-249,rotation:-1.5305,x:6.3,y:-240.35},0).wait(1).to({rotation:-1.4624,x:6.5,y:-240.75},0).wait(1).to({rotation:-1.3309,x:6.9,y:-241.45},0).wait(1).to({rotation:-1.121,x:7.55,y:-242.7},0).wait(1).to({rotation:-0.8372,x:8.4,y:-244.35},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:9.35,y:-246.05},0).wait(1).to({rotation:-0.2881,x:10.05,y:-247.5},0).wait(1).to({rotation:-0.1291,x:10.55,y:-248.4},0).wait(1).to({rotation:-0.0467,x:10.8,y:-248.9},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:11,regY:-249,rotation:0.1421,x:11.75,y:-248.5},0).wait(1).to({rotation:0.6998,x:14.95,y:-246.5},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:1.327,x:18.5,y:-244.25},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(18).to({regX:11,regY:-249,rotation:1.4399,x:19.1,y:-243.85},0).wait(1).to({rotation:1.2196,x:17.85,y:-244.65},0).wait(1).to({rotation:0.7884,x:15.4,y:-246.2},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:12.7,y:-247.9},0).wait(1).to({rotation:0.0482,x:11.2,y:-248.85},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:11,regY:-249,rotation:0.0865,x:11.45,y:-248.75},0).wait(1).to({rotation:0.4213,x:13.4,y:-247.5},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.9973,x:16.65,y:-245.45},0).wait(1).to({rotation:1.3945,x:18.9,y:-244},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(8).to({regX:11,regY:-249,rotation:1.4399,x:19.1,y:-243.85},0).wait(1).to({rotation:1.2196,x:17.85,y:-244.65},0).wait(1).to({rotation:0.7884,x:15.4,y:-246.2},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:12.7,y:-247.9},0).wait(1).to({rotation:0.0482,x:11.2,y:-248.85},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:11,regY:-249,x:11,y:-257.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:11,regY:-249,x:11,y:-258.2},0).wait(1).to({y:-255.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:11,regY:-249,x:8.25,y:-241.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:11,regY:-249,x:11,y:-236.75},0).wait(1).to({y:-239.7},0).wait(1).to({y:-244.65},0).wait(1).to({y:-248.1},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:11,regY:-249,x:11,y:-248},0).wait(1).to({y:-242.05},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:11,regY:-249,x:11,y:-241.2},0).wait(1).to({y:-245.5},0).wait(1).to({y:-249.8},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:11,regY:-249,x:11,y:-249.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(13).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:11,regY:-249,x:8.25,y:-241.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:11,regY:-249,x:11,y:-238.25},0).wait(1).to({y:-246},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:11,regY:-249,x:11,y:-250},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:11,regY:-249,x:11,y:-249.15},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:11,regY:-249,x:11,y:-248.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:11,regY:-249,x:11,y:-248.4},0).wait(1).to({y:-246},0).wait(1).to({y:-243.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:11,regY:-249,x:11,y:-243.6},0).wait(1).to({y:-243.9},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:11,regY:-249,x:11,y:-244.4},0).wait(1).to({y:-245.9},0).wait(1).to({y:-248.15},0).wait(1).to({y:-249.6},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:11,regY:-249,x:11,y:-249.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:11,regY:-249,x:11,y:-256.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:11,regY:-249,x:11,y:-258.2},0).wait(1).to({y:-255.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:11,regY:-249,x:11,y:-256.5},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:11,regY:-249,x:11,y:-257},0).wait(1).to({y:-251},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:11,regY:-249,x:11,y:-244.35},0).wait(1).to({y:-245.55},0).wait(1).to({y:-247.5},0).wait(1).to({y:-248.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:11,regY:-249,x:11,y:-253.95},0).wait(1).to({y:-248.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:11,regY:-249,x:11,y:-253.95},0).wait(1).to({y:-248.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:11,regY:-249,x:11,y:-248.1},0).wait(1).to({y:-248.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:11,regY:-249,x:14,y:-245.6},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:11,regY:-249,x:10.15,y:-239.55},0).wait(1).to({x:10.8,y:-239.15},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:11,regY:-249,x:11,y:-239.7},0).wait(1).to({y:-242.15},0).wait(1).to({y:-245.85},0).wait(1).to({y:-248.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(11).to({regX:11,regY:-249,x:11,y:-248.4},0).wait(1).to({y:-246},0).wait(1).to({y:-243.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:11,regY:-249,x:11,y:-243.65},0).wait(1).to({y:-246},0).wait(1).to({y:-248.4},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(15));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-456.9,-758.6,865.3,891.1);
...
// stage content:
(lib._432_3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:126,scene2:127,end2:242,scene3:243,end3:368,scene4:369,end4:530,scene5:531,end5:671,scene6:672,end6:817,scene7:818,end7:973});
	...
	this.frame_243 = function() {
		...
		this.bg2.gotoAndStop("blur");
	}
	this.frame_266 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "ものなのですね｡";
		exportRoot._u.setText();
	...
	this.frame_437 = function() {
		exportRoot._g.m2 = "ﾌﾟﾛﾃﾞｭｰｻｰさん! ……あ､";
		exportRoot._u.setText();
	...
	this.frame_818 = function() {
		...
		this.bg2.gotoAndPlay("def");
	}
	this.frame_835 = function() {
		exportRoot._g.m1 = "だから､大切なお友達や､";
		exportRoot._u.setText();
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(16).call(this.frame_31).wait(21).call(this.frame_52).wait(18).call(this.frame_70).wait(22).call(this.frame_92).wait(34).call(this.frame_126).wait(1).call(this.frame_127).wait(8).call(this.frame_135).wait(9).call(this.frame_144).wait(36).call(this.frame_180).wait(16).call(this.frame_196).wait(26).call(this.frame_222).wait(20).call(this.frame_242).wait(1).call(this.frame_243).wait(23).call(this.frame_266).wait(24).call(this.frame_290).wait(15).call(this.frame_305).wait(36).call(this.frame_341).wait(27).call(this.frame_368).wait(1).call(this.frame_369).wait(17).call(this.frame_386).wait(20).call(this.frame_406).wait(31).call(this.frame_437).wait(16).call(this.frame_453).wait(21).call(this.frame_474).wait(40).call(this.frame_514).wait(16).call(this.frame_530).wait(1).call(this.frame_531).wait(17).call(this.frame_548).wait(14).call(this.frame_562).wait(27).call(this.frame_589).wait(23).call(this.frame_612).wait(33).call(this.frame_645).wait(26).call(this.frame_671).wait(1).call(this.frame_672).wait(17).call(this.frame_689).wait(57).call(this.frame_746).wait(13).call(this.frame_759).wait(24).call(this.frame_783).wait(34).call(this.frame_817).wait(1).call(this.frame_818).wait(17).call(this.frame_835).wait(20).call(this.frame_855).wait(40).call(this.frame_895).wait(32).call(this.frame_927).wait(21).call(this.frame_948).wait(25).call(this.frame_973).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(978));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(973).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(978));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(959));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(963));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({_off:true},15).wait(963));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(908).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(30));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_2).wait(948).to({_off:false},0).wait(1).to({regX:16.8,regY:-1.3,x:136.8,y:320.2},0).wait(1).to({y:318.5},0).wait(1).to({y:315.2},0).wait(1).to({y:309.85},0).wait(1).to({y:302.4},0).wait(1).to({y:294.05},0).wait(1).to({y:287.1},0).wait(1).to({y:282.55},0).wait(1).to({y:280.25},0).wait(1).to({regX:0,regY:0,x:120,y:280.9},0).to({y:282.9},3).wait(17));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},948).wait(30));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(948).to({_off:false},0).wait(30));

	// white_mask
	this.instance_9 = new lib.white_mask();
	this.instance_9.parent = this;
	this.instance_9.setTransform(120,155,1,1,0,0,0,120,155);
	this.instance_9.alpha = 0.9492;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(948).to({_off:false},0).wait(1).to({alpha:0.946},0).wait(1).to({alpha:0.9359},0).wait(1).to({alpha:0.9181},0).wait(1).to({alpha:0.8915},0).wait(1).to({alpha:0.8552},0).wait(1).to({alpha:0.8079},0).wait(1).to({alpha:0.7485},0).wait(1).to({alpha:0.6761},0).wait(1).to({alpha:0.5902},0).wait(1).to({alpha:0.4924},0).wait(1).to({alpha:0.3863},0).wait(1).to({alpha:0.2794},0).wait(1).to({alpha:0.1811},0).wait(1).to({alpha:0.1007},0).wait(1).to({alpha:0.0434},0).wait(1).to({alpha:0.0104},0).wait(1).to({alpha:0},0).to({_off:true},1).wait(12));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(948).to({_off:false},0).wait(30));

	// white_mask
	this.instance_10 = new lib.white_mask();
	this.instance_10.parent = this;
	this.instance_10.setTransform(120,155,1,1,0,0,0,120,155);
	this.instance_10.alpha = 0.0508;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(936).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(30));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(15).to({_off:false},0).to({alpha:0},3).to({_off:true},1).wait(799).to({_off:false,alpha:1},0).to({alpha:0},7).to({_off:true},1).wait(152));

	// powder
	this.instance_12 = new lib.glitter_rise();
	this.instance_12.parent = this;
	this.instance_12.setTransform(194.25,-43.4,1.0489,1.0489,-2.749,0,0,5.1,-0.4);

	this.instance_13 = new lib.glitter_rise();
	this.instance_13.parent = this;
	this.instance_13.setTransform(125.5,-5.3,1.155,1.0853,-4.8774,0,0,0,6.5);
	this.instance_13.alpha = 0.6992;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_13},{t:this.instance_12}]}).to({state:[]},15).wait(963));

	// effect
	this.instance_14 = new lib.gliter_container();
	this.instance_14.parent = this;
	this.instance_14.setTransform(143.7,-12.25,1.0599,1.0599,-4.2877,0,0,-0.1,2.5);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(15).to({_off:false},0).wait(372).to({regX:0,scaleX:1.1997,scaleY:1.1997,rotation:-4.2598,x:145.75,y:-12.2},35).wait(556));

	// ch1
	this.ch1 = new lib.character1_container();
	this.ch1.name = "ch1";
	this.ch1.parent = this;
	this.ch1.setTransform(-181.65,570,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({regX:0.3,regY:0.3,scaleX:0.5089,scaleY:0.5089,x:123,y:291.15},0).wait(78).to({regX:2.6,regY:-326.7,x:124.05,y:124.75},0).wait(1).to({x:123.85},0).wait(1).to({x:123.45},0).wait(1).to({x:122.9},0).wait(1).to({x:122.15},0).wait(1).to({x:121.1},0).wait(1).to({x:119.85},0).wait(1).to({x:118.2},0).wait(1).to({x:116.25},0).wait(1).to({x:113.85},0).wait(1).to({x:111.1},0).wait(1).to({x:107.95},0).wait(1).to({x:104.65},0).wait(1).to({x:101.35},0).wait(1).to({x:98.3},0).wait(1).to({x:95.7},0).wait(1).to({x:93.65},0).wait(1).to({x:92.05},0).wait(1).to({x:90.95},0).wait(1).to({x:90.2},0).wait(1).to({x:89.8},0).wait(1).to({regX:0.3,regY:0.3,x:88.55,y:291.15},0).wait(14).to({regX:2.6,regY:-326.7,x:89.75,y:124.75},0).wait(1).to({x:89.95},0).wait(1).to({x:90.35},0).wait(1).to({x:90.9},0).wait(1).to({x:91.65},0).wait(1).to({x:92.65},0).wait(1).to({x:93.95},0).wait(1).to({x:95.55},0).wait(1).to({x:97.5},0).wait(1).to({x:99.8},0).wait(1).to({x:102.55},0).wait(1).to({x:105.65},0).wait(1).to({x:109.1},0).wait(1).to({x:112.6},0).wait(1).to({x:116},0).wait(1).to({x:119.1},0).wait(1).to({x:121.65},0).wait(1).to({x:123.7},0).wait(1).to({x:125.3},0).wait(1).to({x:126.4},0).wait(1).to({x:127.15},0).wait(1).to({x:127.55},0).wait(1).to({regX:0.3,regY:0.3,x:126.55,y:291.15},0).wait(93).to({alpha:0},14,cjs.Ease.get(1)).to({_off:true},1).wait(720));

	// bg1
	this.bg = new lib.bg_zoom_half();
	this.bg.name = "bg";
	this.bg.parent = this;
	this.bg.setTransform(-330.15,276,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.bg).wait(15).to({regX:-0.2,regY:-0.4,scaleX:0.5089,scaleY:0.5089,x:-28.65,y:-8},0).wait(78).to({regX:420.1,regY:248.3,x:185.2,y:118.55},0).wait(1).to({x:185.05},0).wait(1).to({x:184.7},0).wait(1).to({x:184.25},0).wait(1).to({x:183.6},0).wait(1).to({x:182.7},0).wait(1).to({x:181.6},0).wait(1).to({x:180.2},0).wait(1).to({x:178.55},0).wait(1).to({x:176.5},0).wait(1).to({x:174.15},0).wait(1).to({x:171.45},0).wait(1).to({x:168.6},0).wait(1).to({x:165.8},0).wait(1).to({x:163.2},0).wait(1).to({x:161},0).wait(1).to({x:159.2},0).wait(1).to({x:157.85},0).wait(1).to({x:156.9},0).wait(1).to({x:156.3},0).wait(1).to({x:155.95},0).wait(1).to({regX:-0.2,regY:-0.4,x:-58.1,y:-8},0).wait(14).to({regX:420.1,regY:248.3,x:155.9,y:118.55},0).wait(1).to({x:156.05},0).wait(1).to({x:156.4},0).wait(1).to({x:156.9},0).wait(1).to({x:157.55},0).wait(1).to({x:158.4},0).wait(1).to({x:159.55},0).wait(1).to({x:160.9},0).wait(1).to({x:162.6},0).wait(1).to({x:164.6},0).wait(1).to({x:167},0).wait(1).to({x:169.7},0).wait(1).to({x:172.7},0).wait(1).to({x:175.75},0).wait(1).to({x:178.7},0).wait(1).to({x:181.35},0).wait(1).to({x:183.6},0).wait(1).to({x:185.4},0).wait(1).to({x:186.75},0).wait(1).to({x:187.7},0).wait(1).to({x:188.35},0).wait(1).to({x:188.7},0).wait(1).to({regX:-0.2,regY:-0.4,x:-25.1,y:-8},0).wait(93).to({alpha:0},14,cjs.Ease.get(1)).to({_off:true},1).wait(720));

	// ch2
	this.ch2 = new lib.character1_container();
	this.ch2.name = "ch2";
	this.ch2.parent = this;
	this.ch2.setTransform(-191.5,575,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.ch2).wait(243).to({regX:0.3,regY:0.1,scaleX:0.6328,scaleY:0.6328,x:130.15,y:330.65},0).wait(1).to({regX:2.6,regY:-326.7,x:131.6,y:123.9},0).wait(1).to({y:124.05},0).wait(1).to({y:124.35},0).wait(1).to({y:124.75},0).wait(1).to({y:125.35},0).wait(1).to({y:126.15},0).wait(1).to({y:127.2},0).wait(1).to({y:128.5},0).wait(1).to({y:130},0).wait(1).to({y:131.4},0).wait(1).to({y:132.6},0).wait(1).to({y:133.45},0).wait(1).to({y:133.95},0).wait(1).to({y:134.25},0).wait(1).to({regX:0.3,regY:0.1,x:130.15,y:341.1},0).wait(111).to({regX:0,regY:0,x:129.95,y:341.05},0).wait(1).to({regX:2.6,regY:-326.7,x:131.55,y:134.3},0).wait(1).to({scaleX:0.6332,scaleY:0.6332,y:134.35},0).wait(1).to({scaleX:0.6337,scaleY:0.6337,y:134.4},0).wait(1).to({scaleX:0.6345,scaleY:0.6345,y:134.45},0).wait(1).to({scaleX:0.6356,scaleY:0.6356,y:134.55},0).wait(1).to({scaleX:0.6371,scaleY:0.6371,x:131.5,y:134.65},0).wait(1).to({scaleX:0.639,scaleY:0.639,y:134.85},0).wait(1).to({scaleX:0.6413,scaleY:0.6413,x:131.45,y:135.05},0).wait(1).to({scaleX:0.6442,scaleY:0.6442,y:135.25},0).wait(1).to({scaleX:0.6476,scaleY:0.6476,y:135.55},0).wait(1).to({scaleX:0.6516,scaleY:0.6516,x:131.4,y:135.9},0).wait(1).to({scaleX:0.6561,scaleY:0.6561,x:131.35,y:136.3},0).wait(1).to({scaleX:0.661,scaleY:0.661,x:131.3,y:136.65},0).wait(1).to({scaleX:0.6657,scaleY:0.6657,y:137.1},0).wait(1).to({scaleX:0.6701,scaleY:0.6701,x:131.25,y:137.45},0).wait(1).to({scaleX:0.6739,scaleY:0.6739,x:131.2,y:137.8},0).wait(1).to({scaleX:0.6769,scaleY:0.6769,x:131.15,y:138},0).wait(1).to({scaleX:0.6792,scaleY:0.6792,x:131.1,y:138.2},0).wait(1).to({scaleX:0.6808,scaleY:0.6808,y:138.35},0).wait(1).to({scaleX:0.6819,scaleY:0.6819,y:138.45},0).wait(1).to({scaleX:0.6825,scaleY:0.6825,y:138.5},0).wait(1).to({regX:0,regY:0,scaleX:0.6826,scaleY:0.6826,x:129.35,y:361.55},0).wait(47).to({regX:2.6,regY:-326.7,x:131.05,y:138.45},0).wait(1).to({scaleX:0.6825,scaleY:0.6825,x:130.95,y:138.3},0).wait(1).to({scaleX:0.6824,scaleY:0.6824,x:130.75,y:138},0).wait(1).to({scaleX:0.6822,scaleY:0.6822,x:130.5,y:137.55},0).wait(1).to({scaleX:0.682,scaleY:0.682,x:130.15,y:136.95},0).wait(1).to({scaleX:0.6816,scaleY:0.6816,x:129.7,y:136.15},0).wait(1).to({scaleX:0.6812,scaleY:0.6812,x:129.1,y:135.2},0).wait(1).to({scaleX:0.6806,scaleY:0.6806,x:128.35,y:133.95},0).wait(1).to({scaleX:0.68,scaleY:0.68,x:127.45,y:132.45},0).wait(1).to({scaleX:0.6792,scaleY:0.6792,x:126.4,y:130.6},0).wait(1).to({scaleX:0.6782,scaleY:0.6782,x:125.1,y:128.5},0).wait(1).to({scaleX:0.6772,scaleY:0.6772,x:123.65,y:126.05},0).wait(1).to({scaleX:0.676,scaleY:0.676,x:122.1,y:123.4},0).wait(1).to({scaleX:0.6748,scaleY:0.6748,x:120.45,y:120.65},0).wait(1).to({scaleX:0.6736,scaleY:0.6736,x:118.85,y:118.05},0).wait(1).to({scaleX:0.6726,scaleY:0.6726,x:117.45,y:115.65},0).wait(1).to({scaleX:0.6717,scaleY:0.6717,x:116.25,y:113.6},0).wait(1).to({scaleX:0.671,scaleY:0.671,x:115.3,y:112.05},0).wait(1).to({scaleX:0.6704,scaleY:0.6704,x:114.55,y:110.8},0).wait(1).to({scaleX:0.6701,scaleY:0.6701,x:114.05,y:109.95},0).wait(1).to({scaleX:0.6698,scaleY:0.6698,x:113.7,y:109.4},0).wait(1).to({scaleX:0.6697,scaleY:0.6697,x:113.5,y:109.1},0).wait(1).to({regX:0.2,regY:0.1,scaleX:0.6696,scaleY:0.6696,x:111.75,y:327.7},0).wait(53).to({regX:2.6,regY:-326.7,x:113.35,y:108.95},0).wait(1).to({x:113.45,y:109.25},0).wait(1).to({x:113.6,y:109.75},0).wait(1).to({x:113.8,y:110.5},0).wait(1).to({x:114.15,y:111.6},0).wait(1).to({x:114.6,y:113.05},0).wait(1).to({x:115.15,y:114.95},0).wait(1).to({x:115.85,y:117.35},0).wait(1).to({x:116.75,y:120.25},0).wait(1).to({x:117.75,y:123.65},0).wait(1).to({x:118.85,y:127.2},0).wait(1).to({x:119.85,y:130.6},0).wait(1).to({x:120.7,y:133.45},0).wait(1).to({x:121.4,y:135.7},0).wait(1).to({x:121.85,y:137.25},0).wait(1).to({x:122.15,y:138.25},0).wait(1).to({x:122.35,y:138.8},0).wait(1).to({regX:0.2,regY:0.1,x:120.8,y:357.8},0).wait(143).to({regX:2.6,regY:-326.7,scaleX:0.6697,scaleY:0.6697,x:122.4,y:138.95},0).wait(1).to({scaleX:0.6699,scaleY:0.6699},0).wait(1).to({scaleX:0.6702,scaleY:0.6702,y:139},0).wait(1).to({scaleX:0.6706,scaleY:0.6706},0).wait(1).to({scaleX:0.6713,scaleY:0.6713},0).wait(1).to({scaleX:0.672,scaleY:0.672,y:139.05},0).wait(1).to({scaleX:0.673,scaleY:0.673,y:139.1},0).wait(1).to({scaleX:0.6742,scaleY:0.6742,y:139.15},0).wait(1).to({scaleX:0.6757,scaleY:0.6757,y:139.2},0).wait(1).to({scaleX:0.6774,scaleY:0.6774,x:122.45,y:139.25},0).wait(1).to({scaleX:0.6794,scaleY:0.6794,y:139.35},0).wait(1).to({scaleX:0.6817,scaleY:0.6817,y:139.45},0).wait(1).to({scaleX:0.6843,scaleY:0.6843,x:122.55,y:139.55},0).wait(1).to({scaleX:0.6873,scaleY:0.6873,y:139.65},0).wait(1).to({scaleX:0.6906,scaleY:0.6906,x:122.6,y:139.8},0).wait(1).to({scaleX:0.6943,scaleY:0.6943,y:139.95},0).wait(1).to({scaleX:0.6983,scaleY:0.6983,x:122.65,y:140.1},0).wait(1).to({scaleX:0.7024,scaleY:0.7024,x:122.7,y:140.3},0).wait(1).to({scaleX:0.7065,scaleY:0.7065,x:122.75,y:140.45},0).wait(1).to({scaleX:0.7105,scaleY:0.7105,x:122.8,y:140.6},0).wait(1).to({scaleX:0.7143,scaleY:0.7143,y:140.75},0).wait(1).to({scaleX:0.7177,scaleY:0.7177,x:122.85,y:140.9},0).wait(1).to({scaleX:0.7206,scaleY:0.7206,y:141},0).wait(1).to({scaleX:0.723,scaleY:0.723,x:122.9,y:141.1},0).wait(1).to({scaleX:0.7251,scaleY:0.7251,x:122.95,y:141.2},0).wait(1).to({scaleX:0.7267,scaleY:0.7267,y:141.25},0).wait(1).to({scaleX:0.7279,scaleY:0.7279,y:141.3},0).wait(1).to({scaleX:0.7288,scaleY:0.7288},0).wait(1).to({scaleX:0.7294,scaleY:0.7294,y:141.35},0).wait(1).to({scaleX:0.7298,scaleY:0.7298},0).wait(1).to({regX:0.2,regY:0.2,scaleX:0.7299,scaleY:0.7299,x:121.25,y:379.95},0).wait(115).to({regX:0.3,regY:0.3,scaleX:0.5089,scaleY:0.5089,x:123,y:291.15},0).to({_off:true},130).wait(30));

	// bg2
	this.bg2 = new lib.bg_zoom_half();
	this.bg2.name = "bg2";
	this.bg2.parent = this;
	this.bg2.setTransform(-340,281,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.bg2).wait(243).to({regX:-0.1,regY:-0.3,scaleX:0.6328,scaleY:0.6328,x:-57.2,y:-42.25},0).wait(1).to({regX:420.1,regY:248.3,x:208.65,y:115.1},0).wait(1).to({y:115.25},0).wait(1).to({y:115.55},0).wait(1).to({y:115.95},0).wait(1).to({y:116.55},0).wait(1).to({y:117.35},0).wait(1).to({y:118.4},0).wait(1).to({y:119.7},0).wait(1).to({y:121.2},0).wait(1).to({y:122.6},0).wait(1).to({y:123.8},0).wait(1).to({y:124.65},0).wait(1).to({y:125.15},0).wait(1).to({y:125.45},0).wait(1).to({regX:-0.1,regY:-0.3,x:-57.2,y:-31.8},0).wait(111).to({regX:0,regY:0,x:-57.15,y:-31.6},0).wait(1).to({regX:420.1,regY:248.3,scaleX:0.6329,scaleY:0.6329,x:208.7,y:125.55},0).wait(1).to({scaleX:0.6332,scaleY:0.6332,x:208.75},0).wait(1).to({scaleX:0.6337,scaleY:0.6337,x:208.8,y:125.6},0).wait(1).to({scaleX:0.6345,scaleY:0.6345,x:208.9,y:125.65},0).wait(1).to({scaleX:0.6356,scaleY:0.6356,x:209.05,y:125.75},0).wait(1).to({scaleX:0.6371,scaleY:0.6371,x:209.2,y:125.85},0).wait(1).to({scaleX:0.639,scaleY:0.639,x:209.45,y:126},0).wait(1).to({scaleX:0.6413,scaleY:0.6413,x:209.65,y:126.15},0).wait(1).to({scaleX:0.6442,scaleY:0.6442,x:210.05,y:126.35},0).wait(1).to({scaleX:0.6476,scaleY:0.6476,x:210.4,y:126.6},0).wait(1).to({scaleX:0.6517,scaleY:0.6517,x:210.85,y:126.9},0).wait(1).to({scaleX:0.6562,scaleY:0.6562,x:211.4,y:127.2},0).wait(1).to({scaleX:0.661,scaleY:0.661,x:212,y:127.6},0).wait(1).to({scaleX:0.6658,scaleY:0.6658,x:212.5,y:127.95},0).wait(1).to({scaleX:0.6702,scaleY:0.6702,x:213.05,y:128.25},0).wait(1).to({scaleX:0.6739,scaleY:0.6739,x:213.45,y:128.55},0).wait(1).to({scaleX:0.6769,scaleY:0.6769,x:213.8,y:128.8},0).wait(1).to({scaleX:0.6792,scaleY:0.6792,x:214.1,y:128.95},0).wait(1).to({scaleX:0.6808,scaleY:0.6808,x:214.25,y:129.05},0).wait(1).to({scaleX:0.6819,scaleY:0.6819,x:214.35,y:129.1},0).wait(1).to({scaleX:0.6825,scaleY:0.6825,x:214.45,y:129.15},0).wait(1).to({regX:0,regY:0,scaleX:0.6827,scaleY:0.6827,x:-72.35,y:-40.35},0).wait(47).to({regX:420.1,regY:248.3,scaleX:0.6826,scaleY:0.6826,x:214.4,y:129.15},0).wait(1).to({x:214.3,y:129},0).wait(1).to({scaleX:0.6824,scaleY:0.6824,x:214.15,y:128.65},0).wait(1).to({scaleX:0.6822,scaleY:0.6822,x:213.85,y:128.25},0).wait(1).to({scaleX:0.682,scaleY:0.682,x:213.45,y:127.65},0).wait(1).to({scaleX:0.6816,scaleY:0.6816,x:212.9,y:126.85},0).wait(1).to({scaleX:0.6812,scaleY:0.6812,x:212.25,y:125.85},0).wait(1).to({scaleX:0.6807,scaleY:0.6807,x:211.45,y:124.6},0).wait(1).to({scaleX:0.68,scaleY:0.68,x:210.45,y:123.1},0).wait(1).to({scaleX:0.6792,scaleY:0.6792,x:209.3,y:121.3},0).wait(1).to({scaleX:0.6783,scaleY:0.6783,x:207.85,y:119.15},0).wait(1).to({scaleX:0.6772,scaleY:0.6772,x:206.25,y:116.75},0).wait(1).to({scaleX:0.676,scaleY:0.676,x:204.5,y:114.05},0).wait(1).to({scaleX:0.6748,scaleY:0.6748,x:202.7,y:111.3},0).wait(1).to({scaleX:0.6736,scaleY:0.6736,x:200.95,y:108.65},0).wait(1).to({scaleX:0.6726,scaleY:0.6726,x:199.35,y:106.3},0).wait(1).to({scaleX:0.6717,scaleY:0.6717,x:198.05,y:104.3},0).wait(1).to({scaleX:0.671,scaleY:0.671,x:197,y:102.65},0).wait(1).to({scaleX:0.6705,scaleY:0.6705,x:196.15,y:101.45},0).wait(1).to({scaleX:0.6701,scaleY:0.6701,x:195.6,y:100.6},0).wait(1).to({scaleX:0.6698,scaleY:0.6698,x:195.2,y:100},0).wait(1).to({scaleX:0.6697,scaleY:0.6697,x:195,y:99.7},0).wait(1).to({regX:0,regY:0,scaleX:0.6696,scaleY:0.6696,x:-86.4,y:-66.7},0).wait(52).to({regX:-0.1,regY:-0.3,x:-86.45,y:-66.9},0).wait(1).to({regX:420.1,regY:248.3,x:194.95,y:99.65},0).wait(1).to({x:195.05,y:99.95},0).wait(1).to({x:195.2,y:100.45},0).wait(1).to({x:195.4,y:101.2},0).wait(1).to({x:195.75,y:102.3},0).wait(1).to({x:196.2,y:103.75},0).wait(1).to({x:196.75,y:105.65},0).wait(1).to({x:197.45,y:108.05},0).wait(1).to({x:198.35,y:110.95},0).wait(1).to({x:199.35,y:114.35},0).wait(1).to({x:200.45,y:117.9},0).wait(1).to({x:201.45,y:121.3},0).wait(1).to({x:202.3,y:124.15},0).wait(1).to({x:203,y:126.4},0).wait(1).to({x:203.45,y:127.95},0).wait(1).to({x:203.75,y:128.95},0).wait(1).to({x:203.95,y:129.5},0).wait(1).to({regX:-0.1,regY:-0.3,x:-77.4,y:-36.8},0).wait(143).to({regX:420.1,regY:248.3,scaleX:0.6697,scaleY:0.6697,x:204,y:129.7},0).wait(1).to({scaleX:0.6699,scaleY:0.6699},0).wait(1).to({scaleX:0.6702,scaleY:0.6702,x:204.05},0).wait(1).to({scaleX:0.6706,scaleY:0.6706,x:204.15},0).wait(1).to({scaleX:0.6713,scaleY:0.6713,x:204.2,y:129.75},0).wait(1).to({scaleX:0.6721,scaleY:0.6721,x:204.3},0).wait(1).to({scaleX:0.6731,scaleY:0.6731,x:204.45},0).wait(1).to({scaleX:0.6743,scaleY:0.6743,x:204.6,y:129.8},0).wait(1).to({scaleX:0.6757,scaleY:0.6757,x:204.8,y:129.85},0).wait(1).to({scaleX:0.6774,scaleY:0.6774,x:205,y:129.9},0).wait(1).to({scaleX:0.6794,scaleY:0.6794,x:205.25,y:129.95},0).wait(1).to({scaleX:0.6817,scaleY:0.6817,x:205.55,y:130},0).wait(1).to({scaleX:0.6843,scaleY:0.6843,x:205.95,y:130.05},0).wait(1).to({scaleX:0.6873,scaleY:0.6873,x:206.35,y:130.15},0).wait(1).to({scaleX:0.6906,scaleY:0.6906,x:206.8,y:130.25},0).wait(1).to({scaleX:0.6943,scaleY:0.6943,x:207.25,y:130.35},0).wait(1).to({scaleX:0.6983,scaleY:0.6983,x:207.8,y:130.45},0).wait(1).to({scaleX:0.7024,scaleY:0.7024,x:208.3,y:130.55},0).wait(1).to({scaleX:0.7065,scaleY:0.7065,x:208.85,y:130.7},0).wait(1).to({scaleX:0.7106,scaleY:0.7106,x:209.4,y:130.8},0).wait(1).to({scaleX:0.7143,scaleY:0.7143,x:209.9,y:130.85},0).wait(1).to({scaleX:0.7177,scaleY:0.7177,x:210.35,y:130.95},0).wait(1).to({scaleX:0.7206,scaleY:0.7206,x:210.7,y:131},0).wait(1).to({scaleX:0.7231,scaleY:0.7231,x:211.05,y:131.1},0).wait(1).to({scaleX:0.7251,scaleY:0.7251,x:211.3,y:131.15},0).wait(1).to({scaleX:0.7267,scaleY:0.7267,x:211.55,y:131.2},0).wait(1).to({scaleX:0.7279,scaleY:0.7279,x:211.7},0).wait(1).to({scaleX:0.7288,scaleY:0.7288,x:211.85},0).wait(1).to({scaleX:0.7294,scaleY:0.7294,x:211.9,y:131.25},0).wait(1).to({scaleX:0.7298,scaleY:0.7298,x:211.95},0).wait(1).to({regX:-0.1,regY:-0.4,scaleX:0.7299,scaleY:0.7299,x:-94.75,y:-50.25},0).wait(115).to({regX:-0.2,scaleX:0.5089,scaleY:0.5089,x:-28.65,y:-8},0).to({_off:true},130).wait(30));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},936).wait(42));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},948).wait(25).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-282,-720,915.5,1383);
// library properties:
lib.properties = {
	id: '_432_3',
	width: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1608864176559", id:"_432_3_bg"},
		{src:"images/bg_blur.jpg?1608864176559", id:"_432_3_bg_blur"},
		{src:"images/ch_base.png?1608864176559", id:"_432_3_ch_base"},
		{src:"images/ch_face2.png?1608864176559", id:"_432_3_ch_face2"},
		{src:"images/ch_face3.png?1608864176559", id:"_432_3_ch_face3"},
		{src:"images/ch_face4.png?1608864176559", id:"_432_3_ch_face4"},
		{src:"images/ch_face6.png?1608864176559", id:"_432_3_ch_face6"},
		{src:"images/ch_face7.png?1608864176559", id:"_432_3_ch_face7"},
		{src:"images/ch_face8.png?1608864176559", id:"_432_3_ch_face8"},
		{src:"images/ch_face9.png?1608864176559", id:"_432_3_ch_face9"},
		{src:"images/ef_breath.png?1608864176559", id:"_432_3_ef_breath"},
		{src:"images/ef_yuge.png?1608864176559", id:"_432_3_ef_yuge"},
		{src:"images/finish.jpg?1608864176559", id:"_432_3_finish"},
		{src:"images/finish_blur.jpg?1608864176559", id:"_432_3_finish_blur"},
		{src:"images/sun_light.png?1608864176559", id:"_432_3_sun_light"},
		{src:"images/tie_fp.png?1608864176559", id:"_432_3_tie_fp"},
		{src:"images/tie_sp.png?1608864176559", id:"_432_3_tie_sp"}
	],
	preloads: []
};
